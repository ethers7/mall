...
-- ----------------------------
-- SECURITY NOTE: the `password` values seeded below for `ums_admin` and
-- `ums_member` are NOT real bcrypt hashes. The original committed hashes
-- were invalidated/rotated (CWE-798 hardcoded-credential remediation) and
-- replaced with the non-functional placeholder
-- '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX' because a
-- real bcrypt hash of a likely-guessable fixture password is crackable
-- offline once committed to git history. No login will succeed against
-- these seeded rows. To get a working account after importing this dump,
-- register a new admin via the public `/admin/register` API (see
-- harness/e2e_apis.sh for an automated example) or use the application's
-- normal member registration flow, supplying your own password at runtime.
-- ----------------------------
...
-- ----------------------------
INSERT INTO `ums_admin` VALUES (1, 'test', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_02.png', 'test@qq.com', '测试账号', NULL, '2018-09-29 13:55:30', '2018-09-29 13:55:39', 1);
INSERT INTO `ums_admin` VALUES (3, 'admin', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_01.png', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2019-04-20 12:45:16', 1);
INSERT INTO `ums_admin` VALUES (4, 'macro', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_01.png', 'macro@qq.com', 'macro', 'macro专用', '2019-10-06 15:53:51', '2020-02-03 14:55:55', 1);
INSERT INTO `ums_admin` VALUES (6, 'productAdmin', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_03.png', 'product@qq.com', '商品管理员', '只有商品权限', '2020-02-07 16:15:08', NULL, 1);
INSERT INTO `ums_admin` VALUES (7, 'orderAdmin', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_04.png', 'order@qq.com', '订单管理员', '只有订单管理权限', '2020-02-07 16:15:50', NULL, 1);
INSERT INTO `ums_admin` VALUES (8, 'test123', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'string', 'abc@qq.com', 'string', 'string', '2022-08-07 14:45:42', NULL, 1);
INSERT INTO `ums_admin` VALUES (9, 'test256', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'string', 'abc@qq.com', 'string', 'string', '2022-08-07 14:52:57', NULL, 1);
INSERT INTO `ums_admin` VALUES (10, 'test1267', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', NULL, 'test1267@qq.com', 'test1267', 'test1267', '2023-01-04 16:13:34', NULL, 1);
...
-- ----------------------------
INSERT INTO `ums_member` VALUES (1, 4, 'test', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'test', '18061581849', 1, '2018-08-02 10:35:44', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_03.png', 1, '2009-06-01', '上海', '学生', 'test', NULL, 3900, 1000, NULL, NULL);
INSERT INTO `ums_member` VALUES (3, 4, 'windy', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'windy', '18061581848', 1, '2018-08-03 16:46:38', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (4, 4, 'zhengsan', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'zhengsan', '18061581847', 1, '2018-11-12 14:12:04', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (5, 4, 'lisi', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'lisi', '18061581841', 1, '2018-11-12 14:12:38', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (6, 4, 'wangwu', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'wangwu', '18061581842', 1, '2018-11-12 14:13:09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (7, 4, 'lion', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'lion', '18061581845', 1, '2018-11-12 14:21:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (8, 4, 'shari', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'shari', '18061581844', 1, '2018-11-12 14:22:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (9, 4, 'aewen', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'aewen', '18061581843', 1, '2018-11-12 14:22:55', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (10, 4, 'guest', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', NULL, '18911111111', 1, '2020-03-14 14:52:18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (11, 4, 'member', '$2a$10$INVALIDPLACEHOLDERSEEDDONOTUSETHISFIXTUREHASHVALUEXXX', 'member', '18961511111', 1, '2023-05-11 15:22:38', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_02.png', 1, '2009-06-01', '上海', '学生', 'member', NULL, 5000, 1000, NULL, NULL);
