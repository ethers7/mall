...
-- ----------------------------
-- 安全说明 / Security note:
-- 后台账号的密码散列不再硬编码在本脚本中（CWE-798，凭证不入版本库）。
-- Admin password hashes are no longer hard-coded in this dump.
-- 导入时通过会话变量传入自己生成的BCrypt散列，例如：
--   mysql -uroot -p mall --init-command="SET @demo_admin_password='<your BCrypt hash>'" < mall.sql
-- 未传入时账号以“无密码”状态导入，任何密码都无法登录（fail closed），
-- 需在导入后自行设置，例如：
--   UPDATE ums_admin SET password='<your BCrypt hash>' WHERE username='admin';
-- 散列可用Spring Security的 BCryptPasswordEncoder().encode("<your password>") 生成。
SET @demo_admin_password = IFNULL(@demo_admin_password, '');
INSERT INTO `ums_admin` VALUES (1, 'test', @demo_admin_password, 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_02.png', 'test@qq.com', '测试账号', NULL, '2018-09-29 13:55:30', '2018-09-29 13:55:39', 1);
INSERT INTO `ums_admin` VALUES (3, 'admin', @demo_admin_password, 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_01.png', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2019-04-20 12:45:16', 1);
INSERT INTO `ums_admin` VALUES (4, 'macro', @demo_admin_password, 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_01.png', 'macro@qq.com', 'macro', 'macro专用', '2019-10-06 15:53:51', '2020-02-03 14:55:55', 1);
INSERT INTO `ums_admin` VALUES (6, 'productAdmin', @demo_admin_password, 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_03.png', 'product@qq.com', '商品管理员', '只有商品权限', '2020-02-07 16:15:08', NULL, 1);
INSERT INTO `ums_admin` VALUES (7, 'orderAdmin', @demo_admin_password, 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_04.png', 'order@qq.com', '订单管理员', '只有订单管理权限', '2020-02-07 16:15:50', NULL, 1);
INSERT INTO `ums_admin` VALUES (8, 'test123', @demo_admin_password, 'string', 'abc@qq.com', 'string', 'string', '2022-08-07 14:45:42', NULL, 1);
INSERT INTO `ums_admin` VALUES (9, 'test256', @demo_admin_password, 'string', 'abc@qq.com', 'string', 'string', '2022-08-07 14:52:57', NULL, 1);
INSERT INTO `ums_admin` VALUES (10, 'test1267', @demo_admin_password, NULL, 'test1267@qq.com', 'test1267', 'test1267', '2023-01-04 16:13:34', NULL, 1);
...
-- ----------------------------
-- 安全说明 / Security note:
-- 会员账号的密码散列不再硬编码在本脚本中（CWE-798，凭证不入版本库）。
-- Member password hashes are no longer hard-coded in this dump.
-- 导入时通过会话变量传入自己生成的BCrypt散列，例如：
--   mysql -uroot -p mall --init-command="SET @demo_member_password='<your BCrypt hash>'" < mall.sql
-- 未传入时账号以“无密码”状态导入，任何密码都无法登录（fail closed），
-- 需在导入后自行设置，例如：
--   UPDATE ums_member SET password='<your BCrypt hash>' WHERE username='member';
-- 也可直接使用前台商城的注册接口注册新的会员账号。
SET @demo_member_password = IFNULL(@demo_member_password, '');
INSERT INTO `ums_member` VALUES (1, 4, 'test', @demo_member_password, 'test', '18061581849', 1, '2018-08-02 10:35:44', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_03.png', 1, '2009-06-01', '上海', '学生', 'test', NULL, 3900, 1000, NULL, NULL);
INSERT INTO `ums_member` VALUES (3, 4, 'windy', @demo_member_password, 'windy', '18061581848', 1, '2018-08-03 16:46:38', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (4, 4, 'zhengsan', @demo_member_password, 'zhengsan', '18061581847', 1, '2018-11-12 14:12:04', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (5, 4, 'lisi', @demo_member_password, 'lisi', '18061581841', 1, '2018-11-12 14:12:38', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (6, 4, 'wangwu', @demo_member_password, 'wangwu', '18061581842', 1, '2018-11-12 14:13:09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (7, 4, 'lion', @demo_member_password, 'lion', '18061581845', 1, '2018-11-12 14:21:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (8, 4, 'shari', @demo_member_password, 'shari', '18061581844', 1, '2018-11-12 14:22:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (9, 4, 'aewen', @demo_member_password, 'aewen', '18061581843', 1, '2018-11-12 14:22:55', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (10, 4, 'guest', @demo_member_password, NULL, '18911111111', 1, '2020-03-14 14:52:18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (11, 4, 'member', @demo_member_password, 'member', '18961511111', 1, '2023-05-11 15:22:38', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_02.png', 1, '2009-06-01', '上海', '学生', 'member', NULL, 5000, 1000, NULL, NULL);
